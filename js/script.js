...
document.querySelector(".first-quote").addEventListener("click", showFirstSlide);
document.querySelector(".second-quote").addEventListener("click", showSecondSlide);
document.querySelector(".third-quote").addEventListener("click", showThirdSlide);